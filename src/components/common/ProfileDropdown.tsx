    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <div className="hidden sm:block text-left">
          <p className="text-xs font-semibold text-stone-900 dark:text-white leading-tight">{user.name || 'User'}</p>
          <p className="text-[11px] text-stone-500 dark:text-stone-400 capitalize">{user.role || 'Job Seeker'}</p>
        </div>
